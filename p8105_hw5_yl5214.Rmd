...
```
The pattern of observation for exposure group is higher than the pattern of observation for the control group from week 1 to week 8. For control group, the observation is oscillateed around 1.25 through week1 to week8. For exposure group, the observation has increase pattern from week 1 to week 8. There are more negative observation in control group than those in the exposure group.
...
plot1
```
Interpretation:As the effect size goes up from 0 to 6, power goes up from 0.00 to 1.00.
