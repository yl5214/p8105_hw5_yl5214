...
```
    ...
    ##   <chr>          <chr>      <chr>       <dbl>
    ## 1 question 2/con 01         1            0.2 
    ## 2 question 2/con 01         2           -1.31
    ## 3 question 2/con 01         3            0.66
    ## 4 question 2/con 01         4            1.96
    ## 5 question 2/con 01         5            0.23
    ## 6 question 2/con 01         6            1.09
